...
```
conda create -n pykurina python=3 six virtualenv pytest pytest-cov
conda activate pykurina
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pykurina.git
   cd pykurina
   ```
...
5. Install [pre-commit]:
   ...
   `pykurina` comes with a lot of hooks configured to automatically help the
